<x-app-layout>
    <div class="transaksi-ins">
        <!-- navigation keluhan -->
        <ul
          class="nav-keluhan nav nav-pills mb-3"
          id="pills-tab"
          role="tablist"
        >
          ...
          <li class="nav-item" role="presentation">
            <a
              id="pills-lunas-tab"
              data-bs-toggle="pill"
              data-bs-target="#pills-lunas"
              type="button"
              role="tab"
              aria-controls="pills-lunas"
              >Lunas</a
            >
          </li>
          <li class="nav-item" role="presentation">
            <a
              id="pills-pasang-tab"
              data-bs-toggle="pill"
              data-bs-target="#pills-pasang"
              type="button"
              role="tab"
              aria-controls="pills-pasang"
              >Pemasangan</a
            >
          </li>
          <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          >
            ...
            <div class="col-md-7 col-sm-12 col-12 pasang">
              ...
              <hr size="4" width="250" />
              <p class="content3">Segera lakukan instalasi baru</p>
            </div>
          </div>
